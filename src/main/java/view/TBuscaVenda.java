 ...
 * @author house
 */
public class TBuscaVenda extends javax.swing.JDialog {
     ...
     */
    public TBuscaVenda(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "status", "flagTipoDesconto", "observacao", "funcionario", "carteirinha", "cliente"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TBuscaVenda dialog = new TBuscaVenda(new javax.swing.JFrame(), true);
