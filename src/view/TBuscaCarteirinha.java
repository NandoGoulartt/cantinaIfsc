 ...
 * @author house
 */
public class TBuscaCarteirinha extends javax.swing.JDialog {
 public JButton getjButtonCarregar() {
     ...
     */
    public TBuscaCarteirinha(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "dataGeracao", "IDCliente", "dataCancelamento", "CodBarra"
            }
        ));
        ...
        jCombobox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "id", "cliente_id", "codigoBarra" }));
        ...
        jPanFiltroLayout.setHorizontalGroup(
            ...
            .addGroup(jPanFiltroLayout.createSequentialGroup()
                .addComponent(jTFFitrar, javax.swing.GroupLayout.PREFERRED_SIZE, 430, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TBuscaCarteirinha dialog = new TBuscaCarteirinha(new javax.swing.JFrame(), true);
