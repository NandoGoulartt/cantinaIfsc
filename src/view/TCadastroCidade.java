...
public class TCadastroCidade extends javax.swing.JDialog {

    /**
     * Creates new form TemplateCadastros
     */
    public TCadastroCidade(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
   }
                    ...
                    .addGroup(jPanDadosLayout.createSequentialGroup()
                        .addGroup(jPanDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanDadosLayout.createSequentialGroup()
                                ...
                                .addGap(33, 33, 33)
                                .addComponent(jTFUf, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TCadastroCidade dialog = new TCadastroCidade(new javax.swing.JFrame(), true);
