...
public class TCadastroBairro extends javax.swing.JDialog {

    /**
     * Creates new form TemplateCadastros
     */
    public TCadastroBairro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
   }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TCadastroBairro dialog = new TCadastroBairro(new javax.swing.JFrame(), true);
