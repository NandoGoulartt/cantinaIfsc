 ...
 * @author house
 */
public class TBuscaProduto extends javax.swing.JDialog {
     ...
     */
    public TBuscaProduto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Status", "Cod de Barra", "Descrição"
            }
        ));
        ...
        jCombobox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "id", "status", "codigoBarra", "descricao" }));
        ...
        jPanFiltroLayout.setHorizontalGroup(
            ...
            .addGroup(jPanFiltroLayout.createSequentialGroup()
                .addComponent(jTFFitrar, javax.swing.GroupLayout.PREFERRED_SIZE, 416, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(7, 7, 7)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TBuscaProduto dialog = new TBuscaProduto(new javax.swing.JFrame(), true);
